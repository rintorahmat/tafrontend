...
function handleFileUpload(event) {
    ...
    fetch('http://34.121.246.28:8000/upload', {
        method: 'POST',
        body: formData,
    })
...
function startPreprocessing() {
    ...
    fetch(`http://34.121.246.28:8000/process/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function deletelines() {
    const fileId = localStorage.getItem('FILE_ID');
    fetch(`http://34.121.246.28:8000/procesblankdata/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function translated() {
    ...
    fetch(`http://34.121.246.28:8000/translated/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function spacing() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/spacing/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function deleteemot() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/delemot/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function removepunc() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/hapustandabaca/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function lowercasing() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/lowercasing/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function tokenizing() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/tokenize/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function stemmed() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/stemmed/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function stopword() {
    const fileId = localStorage.getItem('FILE_ID_HASILPRE');
    fetch(`http://34.121.246.28:8000/stopword/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function sentimenanalis() {
    const fileId = localStorage.getItem('FILE_ID');
    fetch(`http://34.121.246.28:8000/sentimenanalis/${fileId}`, {
        method: 'GET',
    })
    .then(response => response.json())
    .then(data => {
...
function splitData() {
    ...
    fetch(`http://34.121.246.28:8000/splitdata/${fileId}`, {
        method: 'POST',
        headers: {
...
function startklasification() {
    ...
    fetch(`http://34.121.246.28:8000/klasifikasi/?file_id=${hasilpreId}&test_size=${testSize}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        }
...
function downloadData() {
    ...
    fetch(`http://34.121.246.28:8000/download_preprocessed/${processedFileId}`)
        .then(response => {
            if (response.ok) {
